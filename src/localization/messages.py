...
Я помогу вам создать краткие изложения видео с YouTube с помощью ИИ. 
...
**Что я умею:**
🔍 Создавать краткие изложения видео
📝 Извлекать чистые субтитры
✨ Улучшать субтитры с помощью ИИ
...
2. Выберите операцию из интерактивного меню:
   • 📄 <b>Создать изложение</b> - полный анализ видео с помощью ИИ
   • 📝 <b>Чистые субтитры</b> - извлечение субтитров без обработки
   • ✨ <b>Улучшенные субтитры</b> - субтитры с ИИ-коррекцией
